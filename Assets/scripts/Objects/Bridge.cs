...
public class Bridge : map_object
{
    ...
    protected override void Start()
    {
        if (invis == 0)
        {
            TileMapRenderer.RenderBridge(GameWorldController.instance.SceneryModel, CurrentTileMap(), CurrentObjectList(), objInt().ObjectIndex);
        }
